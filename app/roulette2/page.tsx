 ...
 * cyan #22D3EE accents, amber wins, Chakra Petch display + JetBrains Mono
 * numerals). Roulette's red/black/green pockets are kept as the game's own
 * domain colours; only the chrome follows the neon family.
 *
