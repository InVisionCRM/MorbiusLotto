/**
 * /dicex2 — chips Dice x2 (off-chain chips, provably fair).
 *
 * The range / "in" variant of Dice: instead of one roll-under line you pick a
 * band with two handles and win when the roll lands inside it. Same
 * /api/arcade/dicex2/* backend and SIWE session + chip wallet as the rest of
 * the arcade2 family (/dice2, /keno2, /plinko2, /mines2).
 *
...
import { StakeDiceX2Game } from '@/components/StakeDiceX2/StakeDiceX2Game'
...
export default function DiceX2Page() {
  return (
    <GlobalMainNav>
      <div
