/**
 * /pachinko — chips Pachinko (off-chain chips, provably fair).
 *
 * Plinko-family pin-drop with a custom pocket distribution and a rare center
 * jackpot — distinct from the binomial Plinko at /plinko2. Same
 * /api/arcade/pachinko/* backend and SIWE session + chip wallet as the rest of
 * the arcade2 family (/dice2, /keno2, /plinko2, /dicex2).
 *
...
import { PachinkoGame } from '@/components/Pachinko/PachinkoGame'
