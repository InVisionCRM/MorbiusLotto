/**
 * /blackjack-switch — Blackjack Switch (off-chain chips, provably fair).
 *
 * Two hands, one chance to trade their second cards, and a dealer 22 that pushes instead of losing.
 *
...
export default function BlackjackSwitchPage() {
  return (
    <GlobalMainNav>
      <div
          ...
          <main className="w-full max-w-full overflow-x-hidden pb-16 pt-2">
            <header className="mb-6 text-center">
              ...
              <p className="mt-1.5 text-sm text-slate-500">
                two hands · swap the second cards · dealer 22 pushes · super match side bet · provably fair
              </p>
            </header>
            <BlackjackVariantGame variant="switch" />
          </main>
        </div>
        <Footer />
      </div>
