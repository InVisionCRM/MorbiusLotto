/**
 * /ultimate-holdem — Ultimate Texas Hold'em (off-chain chips, provably fair).
 *
 * Player vs dealer, one escalating Play decision across three streets, plus an
 * optional Trips side bet. Same /api/arcade/ultimate-holdem/* backend and SIWE
...
import { UltimateHoldemGame } from '@/components/UltimateHoldem/UltimateHoldemGame';
...
export default function UltimateHoldemPage() {
  return (
    <GlobalMainNav>
      <div
          ...
          <main className="w-full max-w-full overflow-x-hidden pb-16 pt-2">
            <header className="mb-6 text-center">
              <h1 className="arc-display text-3xl font-bold uppercase tracking-[0.08em] text-white sm:text-4xl">
                Ultimate Texas Hold&rsquo;em
                <span className="ml-2 align-middle text-cyan-400 drop-shadow-[0_0_12px_rgba(34,211,238,0.65)]">
                  ♥
                </span>
              </h1>
              <p className="mt-1.5 text-sm text-slate-500">
                bet 4× early or check and bet less later · blind pays up to 500:1 · provably fair · played in MORBIUS
              </p>
            </header>
            <UltimateHoldemGame />
          </main>
