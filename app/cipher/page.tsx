/**
 * /cipher — chips Cipher (off-chain chips, provably fair, Mastermind code-breaking).
 *
 * Theme: "Deep-Sea Neon" — the cyan arcade2 direction shared with /chicken,
 * /towers and /mines2: #050E16 abyss base, cyan #22D3EE accent, Chakra Petch
 * display + JetBrains Mono numerals (the arcade2 font variables).
 *
 * Backend: /api/arcade/cipher/* — stateful start/guess/cashout on the shared
...
import { CipherGame } from '@/components/Cipher/CipherGame';
