/**
 * /mines2 — chips Mines (off-chain chips, provably fair).
 *
 * The web port of the MORBIUS Arcade Mines game: same 5×5 grid and
 * /api/arcade/mines/* backend as the Telegram Mini App, but played with the
 * SIWE session + chip wallet like /keno2 and /plinko2. Built alongside the
 * Mini App so both stay settled by the same server rules.
 *
 * Theme: "Deep-Sea Neon" — the shared arcade2-scope system from keno2
 * (abyss #050E16, cyan #22D3EE accents, amber wins, rose for mines,
 * Chakra Petch display, JetBrains Mono numerals). No hero art yet — the page
 * runs on the abyss gradient; drop a /morbius/Morbius_Mines.png into the
 * backgroundImage stack when the art lands.
 */

import { Chakra_Petch, JetBrains_Mono } from 'next/font/google'
import GlobalMainNav from '@/components/shared/GlobalMainNav'
import Footer from '@/components/PLINKO/Footer'
import { StakeMinesGame } from '@/components/StakeMines/StakeMinesGame'
...
export default function Mines2Page() {
  return (
    <GlobalMainNav>
      <div
