/**
 * /double-exposure — Double Exposure (off-chain chips, provably fair).
 *
 * Both dealer cards face up from the deal — paid for with even-money blackjacks and the dealer taking every tie.
 *
          ...
          <main className="w-full max-w-full overflow-x-hidden pb-16 pt-2">
            <header className="mb-6 text-center">
              ...
              <p className="mt-1.5 text-sm text-slate-500">
                both dealer cards up · blackjack pays even money · dealer wins ties · provably fair · played in MORBIUS
              </p>
            </header>
            <BlackjackVariantGame variant="double_exposure" />
          </main>
        </div>
        <Footer />
      </div>
