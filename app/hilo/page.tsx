/**
 * /hilo — chips Hi-Lo (off-chain chips, provably fair, higher-or-lower).
 *
 * Theme: "Deep-Sea Neon" — the cyan direction HiLoCard/HiLoLadder already
 * commit to: #050E16 abyss base, cyan #22D3EE accent, Chakra Petch display +
 * JetBrains Mono numerals (the arcade2 font variables).
 *
 * Backend: /api/arcade/hilo/* — stateful start/pick/cashout on the shared
 * provably-fair shuffle pipeline. Same SIWE session + chip wallet as the rest
 * of the arcade2 family (/dice2, /mines2, /baccarat).
 */

import { Chakra_Petch, JetBrains_Mono } from 'next/font/google';
import GlobalMainNav from '@/components/shared/GlobalMainNav';
import Footer from '@/components/PLINKO/Footer';
import { StakeHiLoGame } from '@/components/StakeHiLo/StakeHiLoGame';
