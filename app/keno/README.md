...
- Shows a live draw board with draw animations and your tickets for the current round.
...
- Steps:
  ...
  - Toggle add-ons: Bulls-Eye and Pulse Progressive.
...
- Two-column layout:
  - Left: 10×8 grid with live animations, drawn numbers list under the grid, Bulls-Eye indicators, fades on completion.
...
- Prize Pool accordion: pay tables for 1–10 spots and Bulls-Eye variants.
