  ...
  return (
    <html lang="en" className="dark">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&family=Montserrat:wght@500&family=Mitr:wght@400;500;600;700&family=Lilita+One&family=Bungee&family=Titan+One&family=Bangers&family=Rye&family=Bowlby+One+SC&family=Shrikhand&family=Monoton&display=swap" rel="stylesheet" />
      </head>
      <body
