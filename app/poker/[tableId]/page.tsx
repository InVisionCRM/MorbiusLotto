...
/** Same width cap as the poker felt so dashboards align with the table column. */
    ...
    <PokerThemeProvider themeId={pokerTheme}>
      <PokerTableEffectProvider>
        ...
        >
          ...
          {showDashboard && isAdmin && (
            <div className="flex-1 relative min-h-0 z-[25]">
              ...
              <div className="relative z-10 flex h-full min-h-0 w-full justify-center pointer-events-none">
                <div
                  className="pointer-events-auto h-full min-h-0 overflow-y-auto"
                  style={POKER_MAIN_PANEL_STYLE}
                >
          ...
          {/* Player table stats — replaces table when player toggles Table stats */}
