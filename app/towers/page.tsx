/**
 * /towers — chips Towers (off-chain chips, provably fair, 8-floor climb).
 *
 * Theme: "Deep-Sea Neon" — the cyan arcade2 direction shared with /mines2,
 * /baccarat and /hilo: #050E16 abyss base, cyan #22D3EE accent, Chakra Petch
 * display + JetBrains Mono numerals (the arcade2 font variables).
 *
 * Backend: /api/arcade/towers/* — stateful start/pick/cashout on the shared
...
import { StakeTowersGame } from '@/components/StakeTowers/StakeTowersGame';
