/**
 * /dice2 — chips Dice (off-chain chips, provably fair).
 *
 * The web port of the MORBIUS Arcade Dice game: same /api/arcade/dice/*
...
import { StakeDiceGame } from '@/components/StakeDice/StakeDiceGame'
...
export default function Dice2Page() {
  return (
    <GlobalMainNav>
      <div
