 ...
 * both are exposed as CSS vars consumed by the .keno2-scope rules in globals.css.
 */
...
export default function Keno2Page() {
  return (
    <GlobalMainNav>
      <div
        className={`keno2-scope relative min-h-screen h-full w-full flex flex-col text-slate-200 ${kenoDisplay.variable} ${kenoMono.variable}`}
        style={{
          backgroundImage:
        ...
        <div className="relative flex-1 w-full max-w-7xl mx-auto px-3 py-4 sm:px-6 sm:py-8">
          <main className="w-full max-w-full overflow-x-hidden pb-16 pt-2">
            <header className="mb-6 text-center">
              <h1 className="keno-display text-3xl font-bold uppercase tracking-[0.08em] text-white sm:text-4xl">
                Keno
