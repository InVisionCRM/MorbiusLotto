      ...
      <main className="mx-auto max-w-4xl px-3 py-6 sm:px-4">
        ...
        {loading ? (
          ...
          <Card className="arc-panel border-0 p-8 text-center">
            <Dices className="mx-auto mb-3 h-8 w-8 text-slate-600" />
            <p className="arc-display text-sm text-slate-400">No craps tables are open yet.</p>
                ...
                >
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {t.point && (
                        <span className="arc-mono rounded bg-cyan-500 px-1.5 py-0.5 text-[11px] font-bold text-[#04121b]">
                          {t.point}
                        </span>
                      )}
                    </div>
                    <div className="mt-0.5 text-[11px] text-slate-500">
                      {t.minBet.toLocaleString()} – {t.maxBet.toLocaleString()} chips per bet
                    </div>
                  </div>
