/**
 * /chicken — chips Chicken (off-chain chips, provably fair, lane crossing).
 *
 * Theme: "Deep-Sea Neon" — the cyan arcade2 direction shared with /towers,
 * /mines2 and /baccarat: #050E16 abyss base, cyan #22D3EE accent, Chakra Petch
 * display + JetBrains Mono numerals (the arcade2 font variables).
 *
 * Backend: /api/arcade/chicken/* — stateful start/step/cashout on the shared
 * provably-fair HMAC pipeline. Same SIWE session + chip wallet as the rest of
 * the arcade2 family.
 */
...
import { StakeChickenGame } from '@/components/StakeChicken/StakeChickenGame';
