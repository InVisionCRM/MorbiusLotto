/**
 * /heist — chips Heist (off-chain chips, provably fair, vault-cracking climb).
 *
 * Push-your-luck pick-a-door (Mines/Towers family) themed as a vault heist:
 * crack room after room, one safe door per room, escape with the loot any time —
 * trip the alarm and it's over. Same /api/arcade/heist/* backend and SIWE
