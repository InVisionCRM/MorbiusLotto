/**
 * /free-bet-blackjack — Free Bet Blackjack (off-chain chips, provably fair).
 *
 * The house puts up your doubles and splits. In exchange, a dealer 22 pushes instead of losing.
 *
...
export default function FreeBetBlackjackPage() {
  return (
    <GlobalMainNav>
      <div
          ...
          <main className="w-full max-w-full overflow-x-hidden pb-16 pt-2">
            <header className="mb-6 text-center">
              ...
              <p className="mt-1.5 text-sm text-slate-500">
                free doubles on 9/10/11 · free splits · dealer 22 pushes · blackjack pays 3:2 · provably fair
              </p>
            </header>
            <BlackjackVariantGame variant="free_bet" />
          </main>
        </div>
        <Footer />
      </div>
