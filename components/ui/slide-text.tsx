...
interface SlideTextProps {
  ...
  className?: string;
  /** When false, play the slide once on mount/re-key and stop. Default true (loop). */
  loop?: boolean;
}
...
const SlideText = React.forwardRef<HTMLSpanElement, SlideTextProps>(
  (
    ...
    React.useEffect(() => {
      if (prefersReducedMotion || phase !== 'initial' || !loop) return;
    ...
    }, [phase, pauseDuration, prefersReducedMotion, loop]);
