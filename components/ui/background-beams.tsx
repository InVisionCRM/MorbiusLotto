  ...
  ({ className, wideTop = false, title, palette = DEFAULT_PALETTE }: { className?: string; wideTop?: boolean; title?: string; palette?: BeamColorPalette }) => {
    ...
    const beamsDiv = (
      <div
        ...
        style={wideTop ? { transformOrigin: 'bottom center', transform: 'perspective(400px) rotateX(10deg)', overflow: 'hidden' } : undefined}
      >
        <svg
    ...
    if (title) {
      return (
        <div className={cn("relative w-full", className)}>
          <h2 className="text-2xl md:text-3xl font-russo-one font-normal text-white text-center mb-8 relative z-10">
            {title}
          </h2>
