        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className={cn(
                "fixed h-full w-full inset-0 p-10 z-[100] flex flex-col justify-between overflow-y-auto",
                className
              )}
              style={style}
            >
              <div
                className="absolute right-10 top-10 z-50 text-white/80 hover:text-white cursor-pointer"
                onClick={() => setOpen(!open)}
              >
                <IconX />
              </div>
