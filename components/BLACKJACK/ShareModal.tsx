...
export const ShareModal: React.FC<ShareModalProps> = ({
  ...
  const [shareText, setShareText] = useState(
    'Check out my BLACKJACK session! Play now at Win.Morbius.io/BLACKJACK #PulseChain #Crypto #CryptoGaming'
  );
  ...
  const shareToPlatform = async (platform: string) => {
    switch (platform) {
      ...
      case 'download':
        ...
        link.href = imageUrl;
        link.download = `blackjack-session-${Date.now()}.png`;
      ...
      case 'share':
        ...
        let shareData: any = {
          title: 'My BLACKJACK Session!',
          text: shareText,
          url: 'https://Win.Morbius.io/BLACKJACK'
        };
      ...
      <div className="surface-modal-card max-w-sm">
        <div className="p-4">
          ...
          <div className="mt-3 text-center text-cyan-400/60 text-xs">
            Choose how to share your BLACKJACK session!
          </div>
        </div>
      </div>
    </div>
