...
export function BlackjackMobileActionBar({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col h-full gap-2 sm:gap-3 w-full max-w-full">
        {/* Row 1: compact fixed height — do not flex-1 or h-full or row steals space from REBET/DEAL */}
        ...
        >
          <span className="flex flex-col items-center justify-center gap-0 sm:gap-0.5">
            <Plus className="w-5 h-5 sm:w-6 sm:h-6 text-white drop-shadow-sm shrink-0" strokeWidth={2.5} aria-hidden />
            <span className="text-white/95 text-[10px] sm:text-[12px] font-semibold drop-shadow-sm leading-tight">Hit</span>
          </span>
        </button>
        ...
        >
          <span className="flex flex-col items-center justify-center gap-0 sm:gap-0.5">
            ...
            <span className="text-white/95 text-[10px] sm:text-[12px] font-semibold drop-shadow-sm leading-tight">Stand</span>
          </span>
        </button>
        ...
        >
          <span className="flex flex-col items-center justify-center gap-0 sm:gap-0.5">
            ...
            <span className="text-white/95 text-[10px] sm:text-[12px] font-semibold drop-shadow-sm leading-tight">Double</span>
          </span>
        </button>
        ...
        >
          <span className="flex flex-col items-center justify-center gap-0 sm:gap-0.5">
            ...
            <span className="text-white/95 text-[10px] sm:text-[12px] font-semibold drop-shadow-sm leading-tight">Split</span>
          </span>
        </button>
        </div>

        {/* REBET | DEAL row */}
        {!hideDealRow && <div className="flex items-center gap-2 w-full flex-1 min-h-[48px] sm:min-h-[52px]">
