...
const PATH_TO_PAGE: Record<string, NavPage> = {
  ...
  '/crash': 'crash',
  '/roulette2': 'roulette2',
  '/roulette/multi': 'roulette2',
  '/poker': 'poker',
  '/blackjack-multi': 'blackjackMulti',
  '/craps': 'craps',
  '/craps/multi': 'craps',
  '/ultimate-holdem/multi': 'poker',
  '/baccarat': 'baccarat',
  '/hilo': 'hilo',
  '/towers': 'towers',
  '/chicken': 'chicken',
...
const OTHER_GAMES: readonly OtherGameNavItem[] = [
  ...
  { label: 'Multiplayer Craps', href: '/craps/multi', icon: 'users' },
  { label: "Multiplayer Hold'em", href: '/ultimate-holdem/multi', icon: 'users' },
  { label: 'Multiplayer Roulette', href: '/roulette/multi', icon: 'users' },
