              ...
              <div className="relative z-50" ref={menuRef}>
                ...
                {menuOpen && (
                  ...
                  >
                    ...
                    {/* Big Wheel Section */}
                    <div className="p-2 border-b border-gray-700/50">
                      <div className="text-xs text-cyan-300/60 uppercase tracking-wider px-3 py-1">Big Wheel</div>
                      <button
                        onClick={() => {
                      ...
                      <button
                        onClick={() => {
                          if (onShowPayouts) onShowPayouts();
                          setMenuOpen(false);
                        }}
                        className="w-full flex items-center gap-3 px-3 py-2 rounded-md text-gray-300 hover:bg-white/5 hover:text-white transition-colors"
                      >
                        <i className="fas fa-table w-4 text-center"></i>
                        <span className="text-sm font-medium">Payout Table</span>
                      </button>
                      <button
                        onClick={() => {
