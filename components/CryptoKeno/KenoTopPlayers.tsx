...
import { useKenoTopPlayers, type KenoTopPlayerEntry } from '@/hooks/use-keno-results'
...
export default function KenoTopPlayers() {
  const { data: players, isLoading, error } = useKenoTopPlayers(TOP_N)
