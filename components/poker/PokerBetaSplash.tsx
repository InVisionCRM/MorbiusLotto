...
/** Same session: dismissed once applies to /poker and /poker/[tableId]. */
const SESSION_ACK_KEY = 'morbius-poker-beta-splash-ack-v1';

/** Official Morbius channels (matches PokerActivityFeed / in-game help). */
export const POKER_BETA_TELEGRAM_URL = 'https://t.me/MorbiusIO';
export const POKER_BETA_X_URL = 'https://x.com/MorbiusIO';

/**
 * Full-screen notice that Poker is in beta; user must acknowledge before playing.
 * Shown once per browser session until dismissed.
 */
export function PokerBetaSplash() {
    ...
    >
      ...
      >
        ...
        <div className="relative px-5 sm:px-7 pt-6 sm:pt-8 pb-6">
          ...
          <h2 id="poker-beta-splash-title" className="text-xl sm:text-2xl font-bold text-white mb-3">
            Poker is in beta
          </h2>
          <div id="poker-beta-splash-desc" className="text-slate-300 text-sm leading-relaxed space-y-3">
            <p>
          ...
          >
            I have read this — continue to Poker
          </button>
        </div>
      </div>
    </div>
