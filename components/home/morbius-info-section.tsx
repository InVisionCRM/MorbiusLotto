...
const WORD_STYLES: Record<string, string> = {
  ...
  'PUMP.TIRES.': 'bg-gradient-to-r from-purple-400 via-blue-400 to-pink-400 bg-clip-text font-bold uppercase tracking-wide text-transparent',
  partnerships: 'font-semibold text-slate-100',
  shipping: 'font-semibold text-slate-100',
  'product.': 'font-semibold text-slate-100',
  $MORBIUS: 'bg-gradient-to-r from-purple-300 via-violet-400 to-fuchsia-400 bg-clip-text font-semibold text-transparent',
