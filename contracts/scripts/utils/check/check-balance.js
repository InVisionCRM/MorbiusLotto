...
const LOTTERY_INSTANT_ADDRESS = '0xbC21f1228f3D2cb3867Ea504D4007C3ce2dc5CE2';
...
async function main() {
  ...
  const balance = await MORBIUSToken.balanceOf(LOTTERY_INSTANT_ADDRESS);
  const decimals = await MORBIUSToken.decimals();
  
  console.log('Lottery Contract:', LOTTERY_INSTANT_ADDRESS);
