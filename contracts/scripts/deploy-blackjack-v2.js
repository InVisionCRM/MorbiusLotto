...
async function main() {
  ...
  const AUTHORIZED_SERVER = process.env.BLACKJACK_AUTHORIZED_SERVER || "0x0000000000000000000000000000000000000000";
  ...
  console.log("2. Generate and update ABI in abi/blackjack.ts and abi/blackjack.json");
  console.log("3. Fund the contract with MORBIUS for payouts");
  console.log("4. Set bet fee and fee recipient (optional):");
  console.log(`   setBetFee(500)  // 5% fee`);
  console.log(`   setFeeRecipient(address)`);
