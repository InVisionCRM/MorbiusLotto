...
export const WS_MESSAGE_TYPES = {
  ...
  pokerShowCards: 'poker_show_cards',
  ...
  // RPS table mini-game (just-for-fun; outbound events handled via on(...) listeners)
  pokerRpsChallenge: 'poker_rps_challenge',
  pokerRpsRespond: 'poker_rps_respond',
  pokerRpsPick: 'poker_rps_pick',
  pokerRpsLeave: 'poker_rps_leave',
  arcadeInvite: 'arcade_invite',
  arcadeRespond: 'arcade_respond',
  arcadeInput: 'arcade_input',
  arcadeLeave: 'arcade_leave',
  pokerSitOut: 'poker_sit_out',
  pokerSitBack: 'poker_sit_back',
  pokerImBack: 'poker_im_back',
  pokerVoiceToken: 'poker_voice_token',
...
export const WS_POKER_MESSAGES = [
  ...
  WS_MESSAGE_TYPES.pokerShowCards,
...
export const WS_KNOWN_EVENT_TYPES = new Set<string>([
  ...
  WS_MESSAGE_TYPES.pokerAvatarEmotion,
  WS_MESSAGE_TYPES.pokerDirectedEmote,
  // RPS table mini-game (server → client events)
  'poker_rps_challenge',
  'poker_rps_declined',
  'poker_rps_started',
  'poker_rps_picked',
  'poker_rps_reveal',
  'poker_rps_round_cancelled',
  'poker_rps_ended',
  'poker_rps_spectator',
  // Table Arcade mini-games (server → client events)
  'arcade_invite',
  'arcade_declined',
  'arcade_lobby',
  'arcade_countdown',
