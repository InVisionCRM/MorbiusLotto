...
export interface MoneyDatabasePort {
  getExpiredPendingWithdrawals(): Promise<Array<{ wallet_address: string; nonce: string; amount: string }>>;
  ...
  getExpiredPendingForWallet(walletAddress: string): Promise<{ nonce: string; amount: string } | null>;
  ...
  getCreditedPendingDepositByTxHash(txHash: string): Promise<{ wallet_address: string; amount_wei: string } | null>;
  addPlayerBalance(walletAddress: string, amount: bigint): Promise<bigint>;
  getActivePendingWithdrawal(walletAddress: string): Promise<{ nonce: string; amount: string } | null>;
