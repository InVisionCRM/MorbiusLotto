...
/** Generates a random avatar config from the full catalog. Used as a stable placeholder. */
export function randomPlaceholderConfig(_ownedItemKeys?: Set<string>): Record<string, unknown> {
