...
exports.getCashBuyInBoundsChips = getCashBuyInBoundsChips;
/**
...
function getCashBuyInBoundsChips(bigBlindChips) {
    return {
        minChips: bigBlindChips * exports.POKER_CASH_MIN_BUY_IN_BB,
        maxChips: bigBlindChips * exports.POKER_CASH_MAX_BUY_IN_BB,
    };
}
