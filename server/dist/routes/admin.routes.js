...
function registerAdminRoutes({ app, uploadMulter, dbService, pokerGameService, bjMultiService, wsService, chainAnalytics, getHotWalletClient, refreshBjTotalsBackground, getBjTotalsCache, }) {
    ...
    app.post('/api/admin/upload', (req, res, next) => {
        ...
        try {
            ...
            (0, json_1.sendJson)(res, { path: fullUrl });
        }
        catch (err) {
    ...
    app.get('/api/admin/tables', async (req, res) => {
        try {
            ...
            (0, json_1.sendJson)(res, rows.map((r) => ({ ...r, src: ensureProtocol(r.src) })));
        }
        catch (error) {
    ...
    app.post('/api/admin/tables/seed', async (req, res) => {
        try {
            ...
            (0, json_1.sendJson)(res, { inserted, total: tables.length });
        }
        catch (error) {
    ...
    app.post('/api/admin/poker/bots/bootstrap', async (req, res) => {
        try {
         ...
         GROUP BY pt.id`, [tableId]);
            ...
            const proc = (0, child_process_1.spawn)('npm', ['run', 'poker:bot', '--', tableId, String(numBots)], {
                cwd: serverRoot,
                env: process.env,
    ...
    app.get('/api/admin/analytics/contract-snapshots', async (req, res) => {
        try {
            ...
            if (granularity === 'hour' || granularity === 'hourly') {
                ...
                (0, json_1.sendJson)(res, { granularity: 'hourly', hours, snapshots: rows });
            }
            else {
                ...
                (0, json_1.sendJson)(res, { days, snapshots: rows });
            }
        }
        catch (error) {
    ...
    app.get('/api/admin/chat/messages', async (req, res) => {
        try {
            ...
            (0, json_1.sendJson)(res, { roomId, messages, hasMore });
        }
        catch (error) {
    ...
    app.get('/api/admin/chat/blocked', async (_req, res) => {
        try {
            ...
            (0, json_1.sendJson)(res, { addresses });
        }
        catch (error) {
    ...
    app.get('/api/admin/escrow/pools', async (req, res) => {
        try {
            ...
            if (tournamentId) {
                ...
                (0, json_1.sendJson)(res, pools.map(p => ({
                    ...p,
                ...
                (0, json_1.sendJson)(res, detailed);
            }
        }
        catch (error) {
    ...
    app.get('/api/admin/metrics', async (req, res) => {
        ...
        try {
            ...
            try {
                ...
                (0, json_1.sendJson)(res, zeroPayload);
                return;
            }
            (0, json_1.sendJson)(res, {
                range,
