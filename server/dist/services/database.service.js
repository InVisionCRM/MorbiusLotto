...
class DatabaseService {
    ...
    async createBlackjackSpWagerTier(input) {
       ...
       RETURNING id, label, min_bet::TEXT, max_bet::TEXT, theme_kind, theme_id, sort_order, enabled, slug, created_at, updated_at`, [label, input.minBet.toString(), input.maxBet.toString(), themeKind, themeId, sortOrder, slug, enabled]);
        return this.mapBlackjackSpWagerTierRow(r.rows[0]);
    }
