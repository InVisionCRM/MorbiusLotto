-- Custom prize token support for tournaments
-- When prize_token_address is set, prize pool is held in TournamentPrizeEscrow and paid on-chain.
-- When NULL, behavior is unchanged (prize_pool in DB, payouts to players.balance).
...
-- Include prize token in list_active_tournaments
